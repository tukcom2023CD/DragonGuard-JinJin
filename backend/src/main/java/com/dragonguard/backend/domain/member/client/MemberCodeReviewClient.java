...
public class MemberCodeReviewClient
        implements GithubClient<MemberClientRequest, MemberCodeReviewResponse> {
    private static final String PATH_FORMAT =
            "search/issues?q=reviewed-by:%s+type:pr+created:%d-01-01..%s";
