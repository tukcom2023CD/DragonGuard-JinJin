...
public class OrganizationController {
    ...
    @PostMapping
    public ResponseEntity<IdResponse<Long>> saveOrganization(
            @RequestBody @Valid final OrganizationRequest organizationRequest) {
    ...
    public ResponseEntity<IdResponse<Long>> addMemberToOrganization(
            @RequestBody @Valid final AddMemberRequest addMemberRequest) {
