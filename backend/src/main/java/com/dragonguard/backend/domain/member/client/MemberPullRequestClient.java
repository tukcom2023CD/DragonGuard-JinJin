...
public class MemberPullRequestClient
        implements GithubClient<MemberClientRequest, MemberPullRequestResponse> {
    private static final String PATH_FORMAT =
            "search/issues?q=type:pr+author:%s+created:%d-01-01..%s";
