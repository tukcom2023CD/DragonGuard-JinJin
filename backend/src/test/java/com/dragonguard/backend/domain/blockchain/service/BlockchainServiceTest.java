...
class BlockchainServiceTest extends LoginTest {
    ...
    void setTransaction() {
        ...
        memberRepository
                ...
                .ifPresent(m -> m.updateWalletAddress(walletAddress));
        ...
        // blockchainRepository.findAllByMemberAndContributeType(loginUser, ContributeType.COMMIT);
    ...
    void loadEntity() {
        // given
        Blockchain expected =
                blockchainRepository.save(BlockchainFixture.ONE_COMMIT.toEntity(loginUser));
