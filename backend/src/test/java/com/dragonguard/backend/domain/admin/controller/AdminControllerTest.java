...
class AdminControllerTest extends RestDocumentTest {
    ...
    void decideRequest() throws Exception {
        ...
        ResultActions perform =
                mockMvc.perform(
                        post("/admin/organizations/decide")
                                ...
                                .content(
                                        toRequestBody(
                                                new AdminDecideRequest(1L, OrganizationStatus.ACCEPTED)))
                                .header("Authorization", "Bearer apfawfawfa.awfsfawef2.r4svfv32"));
        ...
        perform.andDo(print())
                .andDo(document("accept or deny organization request", getDocumentRequest(), getDocumentResponse()));
    }
    ...
    void getOrganizationsByStatus() throws Exception {
        ...
        perform.andDo(print())
                .andDo(document("get organization list with admin authority", getDocumentRequest(), getDocumentResponse()));
    }
}