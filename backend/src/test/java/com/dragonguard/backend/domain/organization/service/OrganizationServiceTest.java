...
class OrganizationServiceTest extends LoginTest {
    ...
    void addMemberAndSendEmail() {
        ...
        // when
        IdResponse<Long> result =
                organizationEmailFacade.addMemberAndSendEmail(
                        new AddMemberRequest(org.getId(), "tukorea.ac.kr"));
    ...
    class SaveOrg {
        ...
        void saveOrganizationWhenNotExists() {
            ...
            // when
            IdResponse<Long> result =
                    organizationEmailFacade.saveOrganization(
                            new OrganizationRequest(
                                    "한국공학대학교", OrganizationType.UNIVERSITY, "tukorea.ac.kr"));
        ...
        void saveOrganizationWhenExists() {
            ...
            IdResponse<Long> result =
                    organizationEmailFacade.saveOrganization(
                            new OrganizationRequest(
                                    "Google", OrganizationType.COMPANY, "gmail.com"));
    ...
    class GetOrSaveOrg {
        ...
        void getOrganization() {
            ...
            // when
            //            Organization result = organizationService.getOrSaveOrganization(new
            // OrganizationRequest("Google", OrganizationType.COMPANY, "gmail.com"));
        ...
        void saveAndGetOrganization() {
            ...
            // then
            //            Optional<Organization> tukResult =
            // organizationRepository.findById(result.getId());
    ...
    class findOrg {
        ...
        void init() {
            ...
            Organization org =
                    organizationRepository
                            .findByName(OrganizationFixture.TUKOREA.getName())
                            .orElse(null);
            assert org != null;

            organizationRepository
                    .findAllByType(OrganizationType.COMPANY, PageRequest.of(0, 20))
                    .forEach(com -> com.updateStatus(OrganizationStatus.ACCEPTED));
            organizationRepository
                    .findAllByType(OrganizationType.UNIVERSITY, PageRequest.of(0, 20))
        ...
        void findByName() {
            ...
            // when
            IdResponse<Long> result =
                    organizationEmailFacade.getByName(OrganizationFixture.TUKOREA.getName());
