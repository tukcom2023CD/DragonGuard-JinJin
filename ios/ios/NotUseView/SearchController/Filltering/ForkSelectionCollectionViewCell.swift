//
//  ForkSelectionCollectionViewCell.swift
//  ios
//
...
final class ForkSelectionCollectionViewCell: UICollectionViewCell {
    static let identifier = "ForkSelectionCollectionViewCell"
